...
excerpt: 'Here, a new force field parameter (named FB18CMAP) is generated by fitting against quantum mechanics (QM) energy in aqueous solution with ¦Õ/¦× dihedral potential-energy surfaces optimized using CMAP parameters.'
date: 2023-02-17
...
Here, a new force field parameter (named FB18CMAP) is generated by fitting against quantum mechanics (QM) energy in aqueous solution with ¦Õ/¦× dihedral potential-energy surfaces optimized using CMAP parameters.
